...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setColumnWidth(0, 120)  # 设置1列的宽度
        self.tableWidget.setColumnWidth(1, 160)  # 设置2列的宽度
        self.tableWidget.setColumnWidth(2, 70)  # 设置3列的宽度
        self.tableWidget.setColumnWidth(3, 100)  # 设置4列的宽度
        self.tableWidget.setColumnWidth(4, 80)  # 设置5列的宽度
        self.tableWidget.setColumnWidth(5, 100)  # 设置6列的宽度
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "基于OpenCV的车牌识别系统"))
        self.label_0.setText(_translate("MainWindow", "识别图片："))
        self.label.setText(_translate("MainWindow", ""))
        self.label_1.setText(_translate("MainWindow", "识别统计："))
